...
export const CATEGORY_ACHIEVEMENT_TIERS = {
  1: [
    {
      ...
      title: "Wanderer",
      required_count: 20,
      badge_image: BADGE_IMAGES[1],
    },
    {
      level: 2,
      title: "Explorer",
      required_count: 40,
      badge_image: BADGE_IMAGES[2],
    },
    {
      level: 3,
      title: "Adventurer",
      required_count: 80,
      badge_image: BADGE_IMAGES[3],
    },
    {
      level: 4,
      title: "Pathfinder",
      required_count: 160,
      badge_image: BADGE_IMAGES[4],
    },
    {
      level: 5,
      title: "World Seeker",
      required_count: 220,
      badge_image: BADGE_IMAGES[5],
    },
    {
      level: 6,
      title: "Legendary Nomad",
      required_count: 300,
      badge_image: BADGE_IMAGES[6],
    },
  ],
  2: [
    {
  ...
  3: [
    ...
    {
      level: 4,
      title: "Night Conqueror",
      required_count: 160,
      badge_image: BADGE_IMAGES[4],
    },
    {
      level: 5,
      title: "Afterdark Elite",
      required_count: 220,
      badge_image: BADGE_IMAGES[5],
    },
    {
